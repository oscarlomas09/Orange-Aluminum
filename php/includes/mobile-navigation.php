...
<nav role="navigation" id="mobile-navbar" class="visible-xs-block">
    <ul class="first-level" role="menu">
        ...
        <li class="mobile-li" data-target="bar-stock-menu"><span class="glyphicon glyphicon-menu-right"></span> Bar Stock</li>
        <li class="mobile-li" data-target="clips-menu"><span class="glyphicon glyphicon-menu-right"></span> Panel Rails & Clips</li>
