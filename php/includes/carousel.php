<div class="container-fluid" id="carousel-container">
    <div class="row">
        <div id="home-carousel" class="carousel slide col-md-12 hidden-xs" data-ride="carousel">
            <!-- Indicators -->
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img src="img/jumbotron/Assembled_2.jpg" alt="T-Slot">
                    <div class="carousel-caption">
                        T-Slot Framing is Great!
                    </div>
                </div>
                <div class="item">
                    <img src="img/jumbotron/Caps.jpg" alt="Caps">
                    <div class="carousel-caption">
                        Some Random Caps
                    </div>
                </div>
                <div class="item">
                    <img src="img/jumbotron/Uniblock.jpg" alt="Caps">
                    <div class="carousel-caption">
                        Uniblocks
                    </div>
                </div>
                <div class="item">
                    <img src="img/jumbotron/T-Slot.jpg" alt="Caps">
                    <div class="carousel-caption">
                        Uniblocks
                    </div>
                </div>
