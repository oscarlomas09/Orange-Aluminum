    ...
    <div class="row">
        <aside class="visible-md visible-lg col-md-3">
            <ul class="side-navigation">
                ...
                <li><a href="<?php echo BASE_URL; ?>cabinet-and-closet/closet-rods.php"><span class="icon-closet"></span>Closet Rods</a></li>
                <li><a href="<?php echo BASE_URL; ?>caps-corners-coves-and-dividers/divider-bar.php"><span class="icon-divider"></span>Divider Bar</a></li>
                <li><a href="<?php echo BASE_URL; ?>cabinet-and-closet/door-tracks.php"><span class="icon-tracks"></span>Door Tracks</a></li>
                ...
                <li><a href="<?php echo BASE_URL; ?>cabinet-and-closet/file-hanging-rail.php"><span class="icon-rails"></span>File Hanging Rail</a></li>
                <li><a href="<?php echo BASE_URL; ?>bar-stock/flat-bars-radiused.php"><span class="icon-flat-radiused"></span>Flat Bar: Radiused</a></li>
                <li><a href="<?php echo BASE_URL; ?>bar-stock/flat-bars.php"><span class="icon-flat"></span>Flat Bars</a></li>
                <li><a href="<?php echo BASE_URL; ?>cabinet-and-closet/cabinet-trim.php"><span class="icon-cabinet"></span>Garage Cabinet Trim</a></li>
                ...
                <li><a href="<?php echo BASE_URL; ?>bar-stock/hex-bars.php"><span class="icon-hex"></span>Hex Bars</a></li>
                <li><a href="<?php echo BASE_URL; ?>caps-corners-coves-and-dividers/j-cap.php"><span class="icon-j-cap"></span>J Cap Edge Trim</a></li>
                <li><a href="<?php echo BASE_URL; ?>panel-rails.php"><span class="icon-clip-xl"></span>Panel Rails and Clips</a></li>
        ...
        <div class="col-sm-12 col-md-9">
            <div class="container-fluid">
                <div class="row">
                    <h2><a href="<?php echo BASE_URL; ?>bar-stock/index.php">Bar Stock</a></h2>
                ...
                <div class="row">
                    <h2><a href="<?php echo BASE_URL; ?>panel-rails.php">Panel Rails & Clips</a></h2>
                ...
                <div class="row">
                    <h2><a href="<?php echo BASE_URL; ?>fixturing-and-storefront/index.php">Fixturing and Storefront</a></h2>
                    ...
                    <div class="navigation-small visible-xs">
                        <div class="filter">
                            ...
                            <ul>                                
                                ...
                                <li><a href="<?php echo BASE_URL; ?>fixturing-and-storefront/slatwall-systems.php"><span class="icon-slatwall"></span>Slatwall System</a></li>
                                <li><a href="<?php echo BASE_URL; ?>fixturing-and-storefront/slatwall-systems.php"><span class="icon-slatwall-panel"></span>Slatwall Panel</a></li>
                                <li><a href="<?php echo BASE_URL; ?>fixturing-and-storefront/snap-frames.php"><span class="icon-snap-frame"></span>Snap Frames</a></li>
                            </ul>
                        </div>
                        <hr>
                ...
                <div class="row">
                    ...
                    <div class="navigation-small visible-xs">
                        <div class="filter">
                            ...
                            <h4 class="filter-name active">Categories</h4>
                            <ul>                                
                                <li><a href="<?php echo BASE_URL; ?>caps-corners-coves-and-dividers/corners.php"><span class="icon-corners"></span>Corners</a></li>
                                <li><a href="<?php echo BASE_URL; ?>caps-corners-coves-and-dividers/divider-bar.php"><span class="icon-divider"></span>Divider Bars</a></li>
                                <li><a href="<?php echo BASE_URL; ?>caps-corners-coves-and-dividers/j-cap.php"><span class="icon-j-cap"></span>J-Cap</a></li>
                            </ul>
                        </div>
                        <hr>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="navigation-small visible-xs">
                        <div class="filter">
                            ...
                            <h4 class="filter-name active">Categories</h4>
                            <ul>                                
                                <li><a href="<?php echo BASE_URL; ?>cabinet-and-closet/closet-rods.php"><span class="icon-closet"></span>Closet Rod</a></li>
                                <li><a href="<?php echo BASE_URL; ?>cabinet-and-closet/door-tracks.php"><span class="icon-tracks"></span>Door Track</a></li>
                                <li><a href="<?php echo BASE_URL; ?>cabinet-and-closet/file-hanging-rail.php"><span class="icon-rails"></span>File Hanging Rail</a></li>
                                <li><a href="<?php echo BASE_URL; ?>cabinet-and-closet/cabinet-trim.php"><span class="icon-cabinet"></span>Garage Cabinet Trim</a></li>
                                <li><a href="<?php echo BASE_URL; ?>cabinet-and-closet/pulls-and-handles.php"><span class="icon-pulls"></span>Pulls and Handles</a></li>
                                <li><a href="<?php echo BASE_URL; ?>cabinet-and-closet/road-case-sections.php"><span class="icon-case"></span>Road Case Sections</a></li>
