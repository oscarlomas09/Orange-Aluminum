<footer id="footer">
    <div class="container">
            ...
            <div class="col-lg-12">
                ...
                <div class="col-sm-2">
                    ...
                    <ul class="nav collapse" id="footer-shop">
                        <li><a href="#">Custom Extrusions</a></li>
                        <li><a href="#">Stocking Program</a></li>
                        <li><a href="#">Cut to Length</a></li>
        ...
        <div class="row hidden-xs" id="lower-footer">
            ...
            <div class="col-lg-7 other-icons text-right">
                <span class="icon-mastercard"></span>
                <span class="icon-visa"></span>
                <span class="icon-amex"></span>
                <span class="icon-discover"></span>
                <span class="icon-secure"></span><small>SSL</small>
            </div>
        </div>
    </div>
</footer>