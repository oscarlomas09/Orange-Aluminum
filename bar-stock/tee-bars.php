<?php 
    ...
    $t_sections = newPanel("../docs/t_sections.csv", "T Sections", $group);
    ...
    $filter = '<div class="filter collapse" id="filters"><h3 class="title">'.ucfirst($group).' Filter</h3><img class="hidden-xs" src="'.$base_url.'img/products/bars/tee-diagram.png" alt="Diagram"/>'.$filter_option.'<div class="clearfix"></div><div id="reset-btn" class="text-center clearfix">Reset Filters</div></div>';
?>
<!doctype html>
...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="jumbotron"><img src="<?php echo BASE_URL;?>img/jumbotron/tee-bars.jpg" alt="Tee Bars"></div>
        <main class="container-fluid common-container">           
            ...
            <table class="filter-table">
                <tr>
                    ...
                    <td style="width: 150px;"><img src="<?php echo BASE_URL;?>img/products/bars/tee-diagram.png" alt="Diagram" style="max-height: 89px; width: auto;float:right;"/></td>
                </tr>
            </table>
            <div class="row">
                        ...
                        <div class="panel-body container-fluid">
                            <div class="row">
                               ...
                               <div class="col-sm-3 hidden-xs">
                                   <img src="<?php echo BASE_URL;?>img/products/bars/tee-aside.png" alt="Tee Bars" />
                               </div>
                            </div>
                        </div>
                    </div>
