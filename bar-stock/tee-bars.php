<?php 
    ...
    <div class="panel-heading">
        <h3 class="panel-title">T Sections</h3>
    </div>
    ...
    $filter = '<div class="filter collapse" id="filters"><h3 class="title">Tee Bars Filter</h3><img class="hidden-xs" src="'.$base_url.'img/products/bars/tee-diagram.png" alt="Diagram"/>'.$options.'<div class="clearfix"></div><div id="reset-btn" class="text-center clearfix">Reset Filters</div></div>';
?>
<!doctype html>
