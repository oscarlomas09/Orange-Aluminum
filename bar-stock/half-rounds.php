<?php 
    ...
    <div class="panel-heading">
        <h3 class="panel-title">Half Rounds</h3>
    </div>
    ...
    $wall = array( 
        ...
        "options" => array(
            ...
            "three-five-eight" => array(
                "name" => "od-five-eight",
                "title" => '5/8"',
                "group" => "od"
            ),
            "three-three-quarter" => array(
    ...
    $filter = '<div class="filter collapse" id="filters"><h3 class="title">Half Rounds Filter</h3><img class="hidden-xs" src="'.$base_url.'img/products/bars/half-round-diagram.png" alt="Diagram"/>'.$options.'<div class="clearfix"></div><div id="reset-btn" class="text-center clearfix">Reset Filters</div></div>';
?>
<!doctype html>
