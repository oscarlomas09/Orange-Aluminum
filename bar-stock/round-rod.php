<?php 
    ...
    function newPanel($file, $name, $group){      
        ...
        $panel = '<div class="panel panel-default panel-fluid">
                    ...
                    <th>SKU</th>
                    <th class="text-center">Diameter (in)</th>
        ...
        foreach($products as $key => $value){
            ...
            foreach($value as $category){
                ...
                else if($headings[$i] == "diameter-in"){
                    $diameter_in = $category;
                }
                else if($headings[$i] == "diameter-mm"){
                    $diameter_mm = $category;
                }
            ...
            $panel .= '<tr class="filter-row '.rtrim($classes, " ").'">
                ...
                <td class="item-dimensions text-center">'.$diameter_in.'</td>
                <td class="text-center">'.$diameter_mm.'</td>
    ...
    $filter = '<div class="filter collapse" id="filters"><h3 class="title">'.ucfirst($group).' Filter</h3><img class="hidden-xs" src="'.$base_url.'img/products/bars/rod-diagram.png" alt="Diagram"/>'.$filter_option.'<div class="clearfix"></div><div id="reset-btn" class="text-center clearfix">Reset Filters</div></div>';
?>
<!doctype html>
...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="jumbotron"><img src="<?php echo BASE_URL;?>img/jumbotron/rods.jpg" alt="Round Rods"></div>
        <main class="container-fluid common-container">           
            ...
            <table class="filter-table">
                <tr>
                    ...
                    <td style="width: 150px;"><img src="<?php echo BASE_URL;?>img/products/bars/rod-diagram.png" alt="Diagram" style="max-height: 89px; width: auto;float:right;"/></td>
                </tr>
            </table>
            <div class="row">
                        ...
                        <div class="panel-body container-fluid">
                            <div class="row">
                               ...
                               <div class="col-sm-3 hidden-xs">
                                   <img src="<?php echo BASE_URL;?>img/products/bars/rod-aside.png" alt="Round Rods" />
                               </div>
                            </div>
                        </div>
                    </div>
