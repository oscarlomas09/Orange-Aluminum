<?php 
    ...
    $h_sections = newPanel("../docs/h_section.csv", "H Sections", $group);
    $h_connectors = newPanel("../docs/h_connector.csv", "H Connectors", $group);
    ...
    $filter = '<div class="filter collapse" id="filters"><h3 class="title">'.ucfirst($group).' Filter</h3><img class="hidden-xs" src="'.$base_url.'img/products/bars/h-section-diagram.png" alt="Diagram"/>'.$filter_option.'<div class="clearfix"></div><div id="reset-btn" class="text-center clearfix">Reset Filters</div></div>';
?>
<!doctype html>
...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="jumbotron"><img src="<?php echo BASE_URL;?>img/jumbotron/h-section.jpg" alt="H-Sections"></div>
        <main class="container-fluid common-container">           
            ...
            <table class="filter-table">
                <tr>
                    ...
                    <td style="width: 150px;"><img src="<?php echo BASE_URL;?>img/products/bars/h-section-diagram.png" alt="Diagram" style="max-height: 89px; width: auto;float:right;"/></td>
                </tr>
            </table>
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-9">
                    <div class="panel panel-primary hidden-xs">
                        ...
                        <div class="panel-body container-fluid">
                            <div class="row">
                               <div class="col-xs-12 col-sm-9">
                                   <p><h4>H-Shaped Aluminum Bar Stock. Fits material 1/2”, 19/32”, 7/8”, 1” and 2” thick.</h4></p>
                                    <table style="width:100%;">
                                        ...
                                        <tr>
                                            <td><b>Finish</b></td>
                                            <td style="width:75%;">
                                                <a data-toggle="tooltip" title="The natural/raw appearance of the aluminum as it is extruded. No secondary process, may show heavy production lines.">Mill Finish</a> and <a data-toggle="tooltip" title="Clear Anodized Finish, Per MIL-A-8625F. Electrochemical process that is corrosion resistant and protects the material from oxidizing.">Clear Anodized Finish</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><b>Cut Length</b></td>
                                            <td style="width:75%;">3' and 6' Cut Lengths</td>
                                        </tr>
                                        <tr>
                                            <td><b>Tolerance</b></td>
                                            <td style="width:75%;">
                               ...
                               <div class="col-sm-3 hidden-xs">
                                   <img src="<?php echo BASE_URL;?>img/products/bars/h-section-aside.png" alt="H Sectionss" />
                               </div>
                            </div>
                        </div>
                    </div>
                   <?php echo $h_sections; ?>
                   <?php echo $h_connectors; ?>
                </div></div>
        </main>
